...
// Slice para cortar - permite extraer una parte de una cadena
...
console.log( producto.substring(2, 1) );  // Si el número es mayor, SI va a cortar hacia atras (voltear los números)
